  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6">
        ...
        <h1 className="text-6xl sm:text-8xl lg:text-9xl font-display tracking-wider text-gradient-gold leading-none">
          Mogdho Paul
        </h1>

        <p className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-md mx-auto font-light">
